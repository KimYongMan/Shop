...
import com.ym.book.shop.domain.entity.Address;
...
import com.ym.book.shop.domain.entity.item.Book;
...
public class OrderServiceTest {
    ...
    public void 상품주문()throws Exception{
        ...
        //when
        Long orderId = orderService.order(member.getId(), book.getId(), orderConunt);
        ...
        assertEquals("주문 가격은 가격 * 수량이다", 10000 * orderConunt, getOrder.getTotalPrice());
    ...
    public void 상품주문_재고수량초과()throws Exception{
        ...
        int orderConunt = 11;
        //when
        orderService.order(member.getId(), item.getId(), orderConunt);
    ...
    public Member createMember() {
        ...
        member.setName("회원1");
        member.setAddress(new Address("서울", "강남", "1234"));
        em.persist(member);
        return member;
    }
}